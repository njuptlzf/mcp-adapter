...
This project is indexed by GitNexus as **mcp-adapter** (2700 symbols, 5786 relationships, 236 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
